...
type MovePayload struct {
	...
	// destination cell
	DestCell *MovePayload_DestCell `protobuf:"bytes,3,opt,name=dest_cell,json=destCell,proto3" json:"dest_cell,omitempty"`
}
...
type ExitPayload struct {
	...
	FromTerm TeamColor `protobuf:"varint,1,opt,name=from_term,json=fromTerm,proto3,enum=chk.payload.TeamColor" json:"from_term,omitempty"`
}
...
func (x *ExitPayload) GetFromTerm() TeamColor {
	if x != nil {
		return x.FromTerm
	}
	return TeamColor_TEAM_UNSPECIFIED
...
var file_base_payload_proto_rawDesc = []byte{
	...
	0x6b, 0x22, 0xe4, 0x01, 0x0a, 0x0b, 0x4d, 0x6f, 0x76, 0x65, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61,
	...
	0x64, 0x12, 0x3e, 0x0a, 0x09, 0x64, 0x65, 0x73, 0x74, 0x5f, 0x63, 0x65, 0x6c, 0x6c, 0x18, 0x03,
	...
	,
}
...
var file_base_payload_proto_depIdxs = []int32{
	...
	0, // 7: chk.payload.ExitPayload.from_term:type_name -> chk.payload.TeamColor
